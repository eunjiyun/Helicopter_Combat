...
public:
	...
	void CreateCbvSrvDescriptorHeaps(ID3D12Device *pd3dDevice, UINT nConstantBufferViews, UINT nShaderResourceViews);
	void CreateConstantBufferViews(ID3D12Device *pd3dDevice, UINT nConstantBufferViews, ID3D12Resource *pd3dConstantBuffers, UINT nStride);
