...
void CShader::CreateCbvSrvDescriptorHeaps(ID3D12Device *pd3dDevice, UINT nConstantBufferViews, UINT nShaderResourceViews)
{
...
void CShader::CreateConstantBufferViews(ID3D12Device *pd3dDevice, UINT nConstantBufferViews, ID3D12Resource *pd3dConstantBuffers, UINT nStride)
{
	D3D12_GPU_VIRTUAL_ADDRESS d3dGpuVirtualAddress = pd3dConstantBuffers->GetGPUVirtualAddress();
	D3D12_CONSTANT_BUFFER_VIEW_DESC d3dCBVDesc;
	d3dCBVDesc.SizeInBytes = nStride;
	for (UINT j = 0; j < nConstantBufferViews; j++)
	{
